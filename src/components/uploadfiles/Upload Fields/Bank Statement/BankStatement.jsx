...
const BankStatement = ({ files, clearFile, userName, onDataChange, data }) => {
  ...
  const [accno, setAccno] = useState(data.accno || "");
  ...
  const handleAccnoChange = (e) => {
    ...
    onDataChange("accno", e.target.value);
  };
        ...
        <div className="section w-3/4 flex flex-col">
          <div className="flex">
            <h1 className="font-bold flex text-xl font-sans uppercase ">
              <AccountBalanceWalletIcon className="mr-3 h-7 w-7 flex" />
              Bank Statement :
            </h1>
          ...
          <div className="flex">
            <p className="font-bold text-gray-700 text-l font-sans uppercase mb-3 ml-2 flex">
              Bank Details:
            </p>
            <div className="file-input-container flex  mr-20 ml-2 mb-4 text-gray-400 font-sans transition-colors hover:text-gray-700">
              <h1 className="ml-2">Bank Name:</h1>
              <input
                type="text"

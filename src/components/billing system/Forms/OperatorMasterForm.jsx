...
import "./CommonBilling.css";
import { sendDataToOperatorBackend } from "../api";

const OperatorMasterForm = ({ companyId }) => {
  ...
  const departmentOptions = [
    {
      value: "Cardiology",
      label: "Cardiology",
      subDepartments: ["Cardiology_Sub1", "Cardiology_Sub2"],
    },
    {
      value: "Orthopedics",
      label: "Orthopedics",
      subDepartments: ["Orthopedics_Sub1", "Orthopedics_Sub2"],
    },
    {
      value: "Neurology",
      label: "Neurology",
      subDepartments: ["Neurology_Sub1", "Neurology_Sub2"],
    },
    {
      value: "Oncology",
      label: "Oncology",
      subDepartments: ["Oncology_Sub1", "Oncology_Sub2"],
    },
    {
      value: "Pediatrics",
      label: "Pediatrics",
      subDepartments: ["Pediatrics_Sub1", "Pediatrics_Sub2"],
    },
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const dataToSend = { data: formData, companyId: companyId };
        ...
        <div className="right-section">
          ...
          <div className="form-group">
            ...
            >
              ...
              {formData.state &&
                fetchCities(formData.state).map((city) => (
